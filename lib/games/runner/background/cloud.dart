...
class Cloud extends SpriteComponent with ParentIsA<CloudManager>, HasGameRef<RunnerGame> {
  ...
  void onGameResize(Vector2 size) {
    ...
    y = ((absolutePosition.y / 2 - (maxSkyLevel - minSkyLevel)) + random.fromRange(minSkyLevel, maxSkyLevel)) -
