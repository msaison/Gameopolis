...
import 'package:gameopolis/games/runner/obstacle/obstacle.dart';
import 'package:gameopolis/games/runner/obstacle/obstacle_type.dart';
  ...
  void update(double dt) {
    ...
    if (obstacles.isNotEmpty) {
      ...
      if (lastObstacle != null &&
          ...
          (lastObstacle.x + lastObstacle.width + lastObstacle.gap) < gameRef.size.x) {
        addNewObstacle();
